...
def test_update_transaction_status_in_list_found():
    ...
    fs_ops.update_transaction_status_in_list(transactions, "2", fs_ops.TransactionStatus.COMPLETED)
...
def test_update_transaction_status_with_error_message():
    ...
    fs_ops.update_transaction_status_in_list(transactions, "1", fs_ops.TransactionStatus.FAILED, error_message="Test error")
...
def test_main_flow_resume_dry_run(tmp_path):
    ...
    trans_file = test_dir / mfr.MAIN_TRANSACTION_FILE_NAME
    trans_file.write_text(json.dumps([{"id": "1", "TYPE": "FILE_RENAME", "PATH": "test.txt", "STATUS": "COMPLETED"}]))
...
def test_main_flow_reset_dry_run_transactions(tmp_path):
    ...
    trans_file = test_dir / mfr.MAIN_TRANSACTION_FILE_NAME
    trans_file.write_text(json.dumps([{"id": "1", "TYPE": "FILE_RENAME", "PATH": "test.txt", "STATUS": "COMPLETED", "ERROR_MESSAGE": "DRY_RUN"}]))
